...
https://github.com/user-attachments/assets/addd2442-7685-4c22-91ac-d00997bec6c7
...
| :--- | :--- |
| **Frontend** | HTML5, CSS3, SCSS, JavaScript (ES6+), Tailwind CSS |
| **Backend** | Python (Core logic) |
| **Database** | SQL |
| **Design/3D**| Figma (UI/UX), Spline (3D Animation) |
...
This is a static website optimized for performance and smooth user experience.

text
├── index.html      # Main HTML file (Structure)
├── style.css       # Custom CSS (Tailwind overrides & Animations)
├── script.js      # Interactive elements & Custom Cursor
├── logo3.png       # Portfolio Logo
